...
struct Rocket {
    ...
    struct Engine: Decodable {
        enum CodingKeys: String, CodingKey {
            case type, layout, version, propellant_1, propellant_2, amount
        }
...
extension Rocket: Decodable {
    enum CodingKeys: String, CodingKey{
        case height, diameter, mass, first_stage, second_stage, engines, landing_legs, flickr_images, name, active, cost_per_launch, success_rate_ptc, first_flight, wikipedia, description, id
    }
